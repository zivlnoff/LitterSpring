...
public class ApiTest {
    ...
    public void test_proxy_method() {
        ...
        IUserService proxy = (IUserService) Proxy.newProxyInstance(Thread.currentThread().getContextClassLoader(), targetObj.getClass().getInterfaces(), new InvocationHandler() {
            // 方法匹配器
            MethodMatcher methodMatcher = new AspectJExpressionPointcut("execution(* cn.bugstack.springframework.aop.IUserService.*(..))");
    ...
    public void test_advisor() {
        ...
        advisor.setExpression("execution(* cn.bugstack.springframework.aop.IUserService.*(..))");
    ...
    public void test_aop() {
        ...
        center.loadResource("classpath:springAop.xml");
